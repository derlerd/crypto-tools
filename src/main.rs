...
trait EncryptionScheme<RNG : RngCore + CryptoRng, SK, PK, MSG, CTXT> {
...
impl<RNG : RngCore + CryptoRng> EncryptionScheme<RNG, ElGamalSecretKey, ElGamalPublicKey, ElGamalMessage, ElGamalCiphertext>
    for ElGamal<RNG>
{
...
impl ElGamalMessage {
    fn from_string<D : Digest<OutputSize = U64> + Default>(message : String) -> Self {
